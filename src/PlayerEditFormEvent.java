...
public class PlayerEditFormEvent extends EventObject {
	...
	public PlayerEditFormEvent(Object source) {
		super(source);		
	}
	
	public PlayerEditFormEvent(Object source, PlayerObject po) {
		super(source);		
		
		this.po = po;
	}
	
	public PlayerEditFormEvent(Object source, String name, int number, int age, int height, int width, int foot, int gk, int sw, int d, int wb, int dm, int m, int am, int st) {
		super(source);		
